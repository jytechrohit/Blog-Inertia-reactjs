                        ...
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink
                                    ...
                                    active={route().current("postIndex")}
                                >
                                    Posts
                                </NavLink>
                                <NavLink
                                ...
                                <div className="relative group space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                    <NavLink
                                        href={route("category")}
                                        active={
                                    ...
                                    <div
                                        className=" absolute top-5 hidden bg-white rounded-md shadow-lg mt-2 space-y-1 group-hover:block"
